import type { ScienceInfoItem } from "../content/types";

type ScienceInfoGridProps = {
  items: ScienceInfoItem[];
};

export function ScienceInfoGrid({ items }: ScienceInfoGridProps) {
  return (
