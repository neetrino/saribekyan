...
type InternationalSectionNavItem = {
  id: string;
  label: string;
};

type InternationalSectionNavProps = {
  items: InternationalSectionNavItem[];
  ariaLabel: string;
};

export function InternationalSectionNav({
  items,
  ariaLabel,
}: InternationalSectionNavProps) {
